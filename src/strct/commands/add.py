        ...
        if copy_template(source_path, new_template_path):
            ...
            if (new_template_path / '.git').is_dir():
                ...
                if update_template_git(new_template_path):
                    ...
                    print(f"Failed to update Git repository for template '{template_name}'. The template files have been updated, but Git changes were not committed.")
            else:
                print(f"Note: The template '{template_name}' does not have a Git repository.")
        else:
